        ...
        <div class="camlait_row3">
            <div class="camlait_card">
                <div class="camlait_card_header">
                    ...
                    <span class="camlait_link" t-on-click="openTop5Produits">Voir tout</span>
                </div>
            ...
            <div class="camlait_card camlait_card_wide">
                <div class="camlait_kpi_row4" style="margin-bottom:0;">
                    ...
                    <div class="camlait_kpi4_card" t-on-click="openSaleDone">
                        ...
                        <div class="camlait_kpi4_delta neu">
                        ...
                        <div class="camlait_kpi4_sub"><t t-esc="state.ventes.en_attente"/> devis en attente de confirmation</div>
                    </div>
                </div>
            </div>
            ...
            <div class="camlait_row3">
                <div class="camlait_card">
                    <div class="camlait_card_header">
                        ...
                        <span class="camlait_link" t-on-click="openSousSeuilRupture">Voir tout</span>
                    </div>
                    <table class="camlait_table">
...
class CamlaitDashboard extends Component {
    ...
    // "Voir tout" du tableau "Produits sous seuil / en rupture" : doit
    // ouvrir exactement la meme liste que celle affichee dans le tableau
    // (voir action_open_sous_seuil_rupture), et non reutiliser
    // openStockAlert dont le seuil ne correspond pas exactement.
    async openSousSeuilRupture() {
        try {
            const action = await this._rpc('camlait.dashboard', 'action_open_sous_seuil_rupture', {});
            this.actionService.doAction(action);
        } catch(e) { console.error(e); }
    }
    // "Voir tout" du Top 5 produits vendus : doit ouvrir la liste des
    // produits du top 5 (voir action_open_top5_produits), et non l'analyse
    // generale des ventes (pivot du CA total) reutilisee par erreur.
    async openTop5Produits() {
        try {
            const action = await this._rpc('camlait.dashboard', 'action_open_top5_produits', { date_from: this.state.dateFrom, date_to: this.state.dateTo });
            this.actionService.doAction(action);
        } catch(e) { console.error(e); }
    }
